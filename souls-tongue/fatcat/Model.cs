...
namespace souls_tongue
{
	public class Model : IDisposable
	{
		...
		/*public System.Numerics.Vector3? GetLockonPoint()
		{
		...
		//public System.Numerics.Vector3 CurrentTransformPosition => System.Numerics.Vector3.Transform(System.Numerics.Vector3.Zero, CurrentTransform.WorldMatrix);
			...
			: this()
		{
			...
			if (anibnd != null)
			{
				try
				{
					AnimContainer.LoadBaseANIBND(anibnd, null);
					//SkeletonFlver.MapToSkeleton(AnimContainer.Skeleton, false);
				}
				catch
				{
					System.Console.WriteLine("Failed to load Base ANIBND!");
